...
import { Github, X, Database, Layout, Server, Code2 } from "lucide-react";
...
const Projects = () => {
  ...
  // 1. Encontrar el proyecto seleccionado para no mapear dentro del modal
            ...
            <>
              ...
              <div className="fixed inset-0 grid place-items-center z-50 p-4 pointer-events-none">
                <motion.div
                  ...
                  className="bg-[#0f172a] w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl border border-slate-700 pointer-events-auto shadow-2xl shadow-violet-500/20 relative no-scrollbar"
                >
                  {/* BOTÓN X CORREGIDO */}
                  <button
                    onClick={(e) => {
                    ...
                    className="absolute top-4 right-4 p-2 bg-black/60 backdrop-blur rounded-full text-white hover:bg-red-500 hover:rotate-90 transition-all z-50 cursor-pointer"
                  >
                    <X size={20} />
                  </button>
                    ...
                    <div className="space-y-10">
                      ...
                      <div>
                        <h4 className="flex items-center gap-2 text-xl font-semibold text-fuchsia-300 mb-4">
                          <Database size={24} /> {t.projects.responsibilities}
                        </h4>
